                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3 style="text-transform:none">Banner İşlemleri </h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body vendor-table">
                    <a href="{{route('banners.create')}}" class="btn btn-success">+ Ekle</a>
