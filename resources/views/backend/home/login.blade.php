...
<head>
    ...
    <title>Let Yazılım - CMS Sistemleri </title>
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            ...
                            <div>
                                <div>
                                    <h3>Giriş Yapın</h3>
                                    <p>Kullanıcı adınız ve şifrenizle çok kolay bir şekilde giriş yaparak işlemlerinizi yönetebilirsiniz.</p>
                                </div>
                            </div>
                            <div>
                                <div>
                ...
                <div class="col-md-7 p-0 card-right">
                    <div class="card tab2-card">
                        <div class="card-body">
                                    ...
                                    <a class="nav-link active text-center" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><h3 class="text-primary"><span class="icon-user me-2"></span>Sisteme Giriş</h3></a>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form action="{{route('backend.authenticate')}}" method="post" class="form-horizontal auth-form">
                                        <div class="form-group">
                                            <input required="" name="email" type="email" class="form-control" value="{{old('email')}}" placeholder="Kullanıcı Adı" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <div class="form-check">
                                                    <input name="remember" class="form-check-input custom-control-input" type="checkbox"  id="customControlAutosizing">
                                                    <label class="form-check-label" for="customControlAutosizing">Beni Hatırla</label>
                                                </div>
                                            </div>
                                        </div>
...
<script src="/backend/assets/js/jsgrid/griddata-invoice.js"></script>
<script src="/backend/assets/js/jsgrid/jsgrid-invoice.js"></script>
