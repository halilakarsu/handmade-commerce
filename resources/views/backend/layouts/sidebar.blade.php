    ...
    <div class="page-sidebar">
        <div class="sidebar custom-scrollbar">
            ...
            <ul class="sidebar-menu">
                <li><a class="sidebar-header" href="index.html"><i data-feather="home"></i><span>Menüler</span></a></li>
                <li><a class="sidebar-header" href="javascript:void(0)"><i data-feather="box"></i> <span>Ürünler</span><i class="fa fa-angle-right pull-right"></i></a>
                    <ul class="sidebar-submenu">
                        ...
                        <li>
                            ...
                            <ul class="sidebar-submenu">
                                ...
                                <li><a href="product-listdigital.html"><i class="fa fa-circle"></i>Ürünler</a></li>
