        ...
        <div class="row">
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-1">
                                    <li id="img-1"><img src="/backend/assets//images/layout-1/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-2">
                                    <li id="img-2"><img src="/backend/assets//images/layout-1/slider/1.2.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-3">
                                    <li id="img-3"><img src="/backend/assets//images/layout-1/slider/1.3.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
            ...
            <div class="col-xl-2 col-sm-3 pl-0 offer-banner">
                <div class="offer-banner-img">
                    <img src="/backend/assets//images/layout-1/offer-banner.png" alt="offer-banner" class="img-fluid  ">
                </div>
    ...
    <div class="custom-container">
        <div class="row collection collection-layout1">
            <div class="col-md-4 offset-xl-2 p-r-md-0">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="/backend/assets//images/layout-1/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
            ...
            <div class="col-md-4 col-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="/backend/assets//images/layout-1/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>hand</h3>
            ...
            <div class="col-md-2  pl-md-0">
                <div class="collection-banner-main p-top banner-6">
                    <div class="collection-img">
                        <img src="/backend/assets//images/layout-1/collection-banner/7.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h6>10% off</h6>
