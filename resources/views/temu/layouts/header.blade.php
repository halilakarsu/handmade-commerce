...
<head>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="/backend/assets//css/color1.css" media="screen" id="color">
</head>
<body class="bg-light">
                    ...
                    <div class="main-menu-block">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo logo-sm-center">
                                <a href="index.html">
                                    <img src="/backend/assets//images/layout-1/logo/logo.png" class="img-fluid " alt="logo-header">
                                </a>
                            </div>
                        </div>
                                            ...
                                            <li>
                                                <div class="container">
                                                    ...
                                                    <div class="row menu-banner">
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="/backend/assets//images/layout-2/menu-banner/1.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="/backend/assets//images/layout-2/menu-banner/2.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col mega-box product ">
                                                            <div class="mega-img">
                                                                <img src="/backend/assets//images/layout-2/menu-banner/3.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="nav-left">
                                    ...
                                    <div class="collapse show nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font">
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/01.png " alt="catergory-product"> western ware</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/02.png " alt="catergory-product"> TV, Appliances</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/03.png " alt="catergory-product"> Pets Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/04.png " alt="catergory-product"> Car, Motorbike</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/05.png " alt="catergory-product"> Industrial Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/06.png " alt="catergory-product"> Beauty, Health Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/07.png " alt="catergory-product"> Grocery Products </a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/09.png " alt="catergory-product"> Bags, Luggage</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/10.png " alt="catergory-product"> Movies, Music </a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/11.png " alt="catergory-product"> Video Games</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                            <li class="mor-slide-open">
                                                <ul>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                                    ...
                                                    <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/10.png " alt="catergory-product"> Movies, Music </a></li>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/11.png " alt="catergory-product"> Video Games</a></li>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="/backend/assets//images/layout-1/nav-img/12.png " alt="catergory-product"> Toys, Baby Products</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="category-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu gift-dropdown">
                                    <div class="media">
                                        <div  class="me-3">
                                            <img src="/backend/assets//images/icon/1.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Billion Days</h5>
                                            <p><img src="/backend/assets//images/icon/currency.png" class="cash" alt="gift-block"> Flat Rs. 270 Rewards</p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div  class="me-3">
                                            <img src="/backend/assets//images/icon/2.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Fashion Discount</h5>
                                            <p><img src="/backend/assets//images/icon/fire.png"  class="fire" alt="gift-block">Extra 10% off (upto Rs. 10,000*) </p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div  class="me-3">
                                            <img src="/backend/assets//images/icon/3.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div  class="me-3">
                                            <img src="/backend/assets//images/icon/6.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div  class="me-3">
                                            <img src="/backend/assets//images/icon/5.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Beauty store</h5>
                                            <p><img src="/backend/assets//images/icon/currency.png" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
